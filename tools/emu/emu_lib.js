...
async function boot(opts = {}) {
  ...
  await page.evaluate(() => {
    ...
    window.__load = (s) => { emu.pause(); emu.loadSnapshotFromStruct(s); emu.pause(); };   // the page's own frame loop must not run: frames are stepped by hand
  });
